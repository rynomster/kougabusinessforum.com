        ...
        <div class="card month-card">
          ...
          <ul class="event-list">
            ${monthEvents.map(ev => {
              ...
              <a href="${rsvpUrl}" class="event-rsvp-btn">RSVP</a>
              <a href="${ev.link}" target="_blank" class="add-to-cal" title="Add to Google Calendar" aria-label="Add to Google Calendar">+</a>
            </li>`;
            }).join('\n')}
          </ul>
        </div>`;
